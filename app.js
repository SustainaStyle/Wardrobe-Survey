...
const QUESTIONS = [{"en": "I have nothing to Wear, How often you feel?", "hi": "आपको कितनी बार लगता है कि मेरे पास पहनने के लिए कुछ नहीं है?", "en_options": ["Rarely", "Sometimes", "Often", "Almost every day"], "hi_options": ["कभी-कभार", "कभी-कभी", "अक्सर", "लगभग हर दिन"]}, {"en": "I want to improve my style when I go out?", "hi": "जब मैं बाहर जाता/जाती हूँ, तो मैं अपनी स्टाइल बेहतर करना चाहता/चाहती हूँ?", "en_options": ["Rarely", "Sometimes", "Often", "Almost every day"], "hi_options": ["कभी-कभार", "कभी-कभी", "अक्सर", "लगभग हर दिन"]}, {"en": "Do you ever feel your wardrobe is missing something but can't figure out what?", "hi": "क्या आपको कभी लगता है कि आपकी अलमारी में कुछ कमी है, लेकिन समझ नहीं आता कि क्या?", "en_options": ["Rarely", "Sometimes", "Often", "Almost every day"], "hi_options": ["कभी-कभार", "कभी-कभी", "अक्सर", "लगभग हर दिन"]}, {"en": "How often do you plan outfits in advance for specific occasions or events?", "hi": "विशेष अवसरों या कार्यक्रमों के लिए आप कितनी बार पहले से कपड़े तय करते हैं?", "en_options": ["Never", "Sometimes", "Often", "Always"], "hi_options": ["कभी नहीं", "कभी-कभी", "अक्सर", "हमेशा"]}, {"en": "Do you have clothes in your wardrobe that you have never worn or rarely wear?", "hi": "क्या आपकी अलमारी में ऐसे कपड़े हैं जिन्हें आपने कभी नहीं पहना या बहुत कम पहनते हैं?", "en_options": ["Yes, many", "Yes, a few", "Very few", "No"], "hi_options": ["हाँ, बहुत सारे", "हाँ, कुछ", "बहुत कम", "नहीं"]}, {"en": "How many clothes in your wardrobe do you feel no longer suit your style?", "hi": "आपकी अलमारी में कितने कपड़े अब आपकी स्टाइल के अनुसार नहीं हैं?", "en_options": ["Many", "Some", "Very few", "None"], "hi_options": ["बहुत सारे", "कुछ", "बहुत कम", "एक भी नहीं"]}, {"en": "Do you ever feel that something is missing from your wardrobe but cannot figure out exactly what it is?", "hi": "क्या आपको कभी लगता है कि आपकी अलमारी में कुछ कमी है, लेकिन आप ठीक-ठीक समझ नहीं पाते कि क्या?", "en_options": ["Rarely", "Sometimes", "Often", "Very often"], "hi_options": ["कभी-कभार", "कभी-कभी", "अक्सर", "बहुत अक्सर"]}, {"en": "I want to maximize outfit options while minimizing the number of clothes in my wardrobe", "hi": "मैं अपनी अलमारी में कपड़ों की संख्या कम रखते हुए अधिक आउटफिट विकल्प चाहता/चाहती हूँ", "en_options": ["Not interested", "Slightly interested", "Interested", "Very interested"], "hi_options": ["रुचि नहीं है", "थोड़ी रुचि है", "रुचि है", "बहुत रुचि है"]}, {"en": "Do you need help deciding what to buy next?", "hi": "क्या अगली बार क्या खरीदना है, यह तय करने में आपको मदद चाहिए?", "en_options": ["Rarely", "Sometimes", "Often", "Very often"], "hi_options": ["कभी-कभार", "कभी-कभी", "अक्सर", "बहुत अक्सर"]}, {"en": "How often do you shop for clothes?", "hi": "आप कपड़ों की खरीदारी कितनी बार करते हैं?", "en_options": ["Weekly", "Monthly", "Once every 2–3 months", "A few times a year", "Only when required"], "hi_options": ["हर सप्ताह", "हर महीने", "हर 2–3 महीने में एक बार", "साल में कुछ बार", "केवल आवश्यकता होने पर"]}, {"en": "Where do you usually shop for clothes?", "hi": "आप सामान्यतः कपड़ों की खरीदारी कहाँ से करते हैं?", "en_options": ["Local stores (Off-line)", "Myntra", "AJIO", "Nykaa Fashion", "Tata CLiQ", "Other"], "hi_options": ["स्थानीय दुकानें (ऑफलाइन)", "Myntra", "AJIO", "Nykaa Fashion", "Tata CLiQ", "अन्य"], "type": "checkbox"}];
